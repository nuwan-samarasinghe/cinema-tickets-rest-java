...
@DisplayName("SeatReservationServiceExceptionTest")
class SeatReservationServiceExceptionTest {
    ...
    void givenMessage_whenExceptionCreated_thenMessageIsSet() {
        SeatReservationServiceException exception
                = new SeatReservationServiceException("Something went wrong");
    ...
    void givenMessageAndCause_whenExceptionCreated_thenMessageAndCauseAreSet() {
        ...
        SeatReservationServiceException exception
                = new SeatReservationServiceException("Something went wrong", cause);
